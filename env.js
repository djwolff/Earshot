 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.earshot.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.earshot'; // ios bundle id
const PACKAGE = 'com.earshot'; // android package name
const NAME = 'Earshot'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'Earshot'; // app scheme
